...
//                    Dictionary(uniqueKeysWithValues: zip(names, colors))
//                        .merging(["정상 범위": standard == nil ? .clear : .mainBlue]) { (_, new) in new }
//                )
...
//    RawDataGraph(
//        name: "승모",
//        rawData: [0, 1, 2, 3, 4, 3, 2, 1, 0, 1, 2, 3, 4, 3, 2, 1, 0, 1, 2, 3, 4, 3, 2, 1, 0],
////        name2: "승모 2",
////        rawData2: [1, 2, 3, 4, 3, 2, 1, 0, 1, 2, 3, 4, 3, 2, 1, 0, 1, 2, 3, 4, 3, 2, 1, 0, 1],
//        standard: [2, 50],
//        minData: -1,
//        maxData: 5
//        
