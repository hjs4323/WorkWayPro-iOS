...
struct TestLineView: View {
    var body: some View {
        GeometryReader { geo in
            let labels = ["23.05.01", "05.03", "06.01", "24.01.02", "01.03", "01.04", "01.05"]
            //        ScrollView(.horizontal) {
            LineGraph(labels: labels, subLabels: ["11:00", "11:00", "11:00", "11:00", "11:00", "11:00", "11:00"], scores: [60, 95, 80, 70, 70, 70, 70])
                .frame(width: geo.size.width - 32, height: 150)
                .padding(.horizontal, 16)
            //        }
            //        .disabled(labels.count < 8)
        }
    }
}
    ...
    GeometryReader { geo in
        ...
        VStack {
            ...
            HStack{
                ...
                LineGraph(
                    labels: labels,
                    subLabels: ["11:00", "11:00", "11:00", "11:00", "11:00", "11:00", "11:00"],
                    scores: [60, 95, 80, 70, 70, 70, 70],
                    minStandard: 0,
                    maxStandard: 50
                )
