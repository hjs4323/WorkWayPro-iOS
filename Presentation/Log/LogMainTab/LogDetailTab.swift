...
//                TabView{
//                    ForEach(0..<reportBTs.count, id: \.self){ index in
//                        let report = reportBTs[index]
//                        VStack{
//                            Button(action: {
//                                store.send(.goToBTReport(index))
//                            }, label: {
//                                VStack(alignment: .leading, spacing: 0){
//                                    Spacer().frame(height: 20)
//                                    
...
//                                        
//                                        CircleGraph(data: report.max[0], maxData: store.btParam.maxBor[0], unit: "µV", color: .compareBlue)
//                                            .frame(width: 90, height: 90)
...
//                                        CircleGraph(data: report.max[safe: 1], maxData: store.btParam.maxBor[1], unit: "µV", color: .mainBlue)
//                                            .frame(width: 90, height: 90)
//                                            .overlay(alignment: .bottom){
//                                                Text("2번")
//                                                    .font(.r_12())
...
//                                        Spacer().frame(width: 30)
//                                        
//                                        CircleGraph(data: report.mean[0], maxData: store.btParam.meanBor[0], unit: "µV", color: .whiteLightGray)
//                                            .frame(width: 90, height: 90)
//                                            .overlay(alignment: .bottom){
//                                                Text("1번")
//                                                    .font(.r_12())
...
//                                        
//                                        Spacer().frame(width: 25)
//                                        CircleGraph(data: report.mean[safe: 1], maxData: store.btParam.meanBor[1], unit: "µV", color: .lightGraySet)
//                                            .frame(width: 90, height: 90)
//                                            .overlay(alignment: .bottom){
//                                                Text("2번")
//                                                    .font(.r_12())
