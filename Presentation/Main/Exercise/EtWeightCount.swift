...
// reportet를 들고 다닌다
// logictrigger -> setReport 반환
// 1세트 진행 -> etreport initailize
// (id, report) 형태
// id -> reportEt에 reportset에 삽입용
// dynamic == rawdata
// mainlist 순서는 그냥 추가 순

//#Preview{
//    NavigationStack{
//        EtWeightCountView(store: Store(initialState: EtWeightCount.State(who: "", report: testReportET, rawDatas: testRawDatas), reducer: {
//            EtWeightCount()
//        }))
//    }
//}
