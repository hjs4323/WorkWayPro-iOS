    ...
    var body: some View {
        GeometryReader { geometry in
            VStack(alignment: .leading, spacing: 0) {
                ...
                #if DEBUG
                testButton(action: {
                    let testClip = store.isLeft ? testClip1 : testClip2
                    bluetoothManager.tempClip = testClip
                })
                #endif
            }//최외곽 VStack
...
//#Preview {
//    NavigationStack {
//        AttachClipView(store: Store(initialState: AttachClip.State.init(attachMuscle: test), reducer: {
//            AttachClip()
//        }))
